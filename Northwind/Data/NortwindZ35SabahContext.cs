...
{
    public partial class NortwindZ35SabahContext : DbContext
    {
        public NortwindZ35SabahContext()
        {
        }

        public NortwindZ35SabahContext(DbContextOptions<NortwindZ35SabahContext> options)
            : base(options)
        {
        }
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer("Server=.\\SQLEXPRESS;Database=NortwindZ35Sabah;Integrated Security=true");
            }
        }
